...
func NewValue(cfg *Config, docPkg *doc.Package, allPackages []*doc.Package, doc *doc.Value) *Value {
	return &Value{cfg, docPkg, allPackages, doc}
}
...
func (v *Value) Doc() *Doc {
	return NewDoc(v.cfg.Inc(1), v.docPkg, v.allPackages, v.doc.Doc)
}
